      ...
      <div className="px-8 py-5 border-b border-bank-gold/10 flex items-center justify-between bg-bank-navy">
        ...
        {!analysis && !isAnalyzing && (
          <button
            ...
            className="flex items-center gap-2 px-6 py-2.5 bg-bank-gold hover:bg-bank-goldLight text-bank-obsidian rounded-sm text-[10px] font-black uppercase tracking-[0.2em] transition-all duration-300 ease-out active:scale-[0.98]"
          >
